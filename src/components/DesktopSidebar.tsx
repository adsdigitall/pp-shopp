...
export const DesktopSidebar: React.FC<DesktopSidebarProps> = ({ activeSection = 'garimpar', onNavigate, onDispatch, onGroups, onSettings, onNotifications, onAnalytics }) => {
  const groups = [
  ...
  return <aside className="fixed inset-y-0 left-0 z-30 hidden w-[232px] flex-col border-r border-zinc-800 bg-[#111114] px-3 py-5 text-zinc-300 lg:flex">
